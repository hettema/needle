...
**Carried by:** docs/plans/done/2026-09-05-a-full-machine-admits-nothing-new-and-a-lane-that-comes-back-is-one-lane.md — folded from the board's Idea door on 2026-09-05 (conversation 6b683c8b), which read it and #53 as one loop pass from one conversation
**Kind:** defect
