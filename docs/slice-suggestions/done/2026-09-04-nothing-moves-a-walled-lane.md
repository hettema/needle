...
**Carried by:** docs/plans/2026-09-05-work-the-laptop-interrupted-comes-back-by-itself-and-the-board-says-truly-how-it-ended.md — folded from the board's Idea door on 2026-09-05 (conversation 6b683c8b), which read it beside #32, #33 and #68 as four findings about one loop; its first finding is already fixed, its second is item 3
**Kind:** defect
**Fix:** now
