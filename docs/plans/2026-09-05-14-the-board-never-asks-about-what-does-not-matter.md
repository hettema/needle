...
**Sequencing:** after 11 (shares `Doors.close` and the brief; 11's item 1 changes the same door) and after 08 (the parsers). Reuses plan 09's reading session and its replacement-row door for item 4; nothing is invented where those exist.
